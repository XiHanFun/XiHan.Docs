...
| 册 | 定位 | 什么时候看 |
| --- | --- | --- |
| **[开发指南](./guide/modularity)** | **按能力域编号**的任务式文档（34 章） | 「我要做 X」——数据访问、事务、认证、缓存、多租户… |
...
| 5–7 | 配置与选项 · Web 应用开发 · 动态 API |
| 8–9 | 数据访问 · 工作单元与事务 |
| 10–12 | 多租户 · 认证与授权 · 缓存与分布式锁 |
| 13–17 | 事件总线 · 定时任务与后台作业 · 工作流 · 日志 · 审计 |
| 18–24 | 国际化 · 对象存储 · 消息与机器人 · 实时通信 · HTTP · 加解密 · 对象映射 |
| 25–32 | 序列化 · 数据校验 · 分布式 ID · 模板引擎 · 搜索 · AI 与 MCP · 网关 · 可观测性 |
| 33–34 | 扩展与二次开发 · 常见问题 |
